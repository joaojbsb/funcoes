CREATE OR REPLACE FUNCTION "SCH".fc_repactuacao_super_refis(
...
--Junior CPD
	...
	tem_debito = (select * from "SCH".fnc_debitos_vencidos_imovel_aguaslindas(devedor));
	RAISE NOTICE 'TEM DEBITOS % CCI % ', tem_debito, devedor;
